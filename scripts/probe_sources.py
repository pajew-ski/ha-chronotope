...
def endpoints(lat: float, lon: float) -> list[tuple[str, str, dict]]:
    ...
    items = [
        ...
        ("onionoo_details", "https://onionoo.torproject.org/details?type=relay&running=true&limit=3&fields=nickname,fingerprint,flags,observed_bandwidth,country", {}),
        ...
        ("natural_earth_regions", "https://raw.githubusercontent.com/nvkelso/natural-earth-vector/v5.1.2/geojson/ne_50m_geography_regions_polys.geojson", {}),
        ...
        ("gibs_black_marble_tile", "https://gibs.earthdata.nasa.gov/wmts/epsg3857/best/VIIRS_Black_Marble/default/2016-01-01/GoogleMapsCompatible_Level8/3/2/4.png", {}),
